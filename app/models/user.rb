class User < ApplicationRecord
  ...
  has_many :call_logs
	...
	validates :token,inclusion: { in: User::VALID_TOKENS }
  ...
  enum role: [:student_volunteer, :hotline_teacher, :beat_math_teacher, :call_it_reading_teacher, :mnps_teacher, :administrator, :specialist]
